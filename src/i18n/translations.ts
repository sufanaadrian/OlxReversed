export const translations = {
  en: {
    ...
    scheduleEmptyHint: "Toggle a day and add time slots",
    selectStartTime: "Start time",
    selectEndTime: "End time",
    presetMornings: "Mornings",
    presetAfternoons: "Afternoons",
    presetFullWeekdays: "Full Weekdays",
    presetWeekends: "Weekends",
    presetEvenings: "Evenings",
    ...
    jobSectionSchedule: "Availability",
    scheduleSeekingHint: "When are you available for this job?",
    ...
    scheduleDateRange: "Schedule date range",
    scheduleDateRangeHint:
      "Set a start and end date to generate specific scheduling slots from your weekly template",
  ...
  ro: {
    ...
    sundayShort: "Du",
    scheduleHour: "Oră",
    scheduleMinute: "Minut",
    slotBooked: "Rezervat",
    slotPending: "În așteptare",
    slotAvailable: "Disponibil",
    addTimeSlot: "Adaugă interval",
    scheduleEmptyHint: "Activează o zi și adaugă intervale orare",
    selectStartTime: "Ora de început",
    selectEndTime: "Ora de sfârșit",
    presetMornings: "Dimineți",
    presetAfternoons: "După-amiezi",
    presetFullWeekdays: "Zile lucrătoare",
    presetWeekends: "Weekend",
    presetEvenings: "Seri",
    noSlotsAvailable: "Nu sunt intervale disponibile",
    slotSelected: "interval selectat",
    slotsSelected: "intervale selectate",
    availabilitySchedule: "Program disponibilitate",
    jobSectionSchedule: "Disponibilitate",
    scheduleSeekingHint: "Când ești disponibil pentru acest job?",
    ...
    scheduleDateRange: "Intervalul de date",
    scheduleDateRangeHint:
      "Setați o dată de început și de sfârșit pentru a genera intervale specifice din șablonul săptămânal",
